...
public class InventoryAdapter extends RecyclerView.Adapter<InventoryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.txtMedicine.setText(item.getMedicineName());
        holder.txtCategory.setText(item.getCategory());
        holder.txtPrice.setText(item.getPrice());

        holder.progressStock.setMax(item.getMaxStock());
        holder.progressStock.setProgress(item.getStock());
        ...
        if (item.getStock() == 0) {
            ...
            holder.txtStock.setText(item.getStock() + " units - Low Stock");
            holder.txtStock.setTextColor(Color.parseColor("#E53935"));

        } else {

            holder.txtStock.setText(item.getStock() + " units");
    ...
    public void updateList(ArrayList<InventoryModel> newList) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView txtMedicine, txtCategory, txtPrice, txtStock;
