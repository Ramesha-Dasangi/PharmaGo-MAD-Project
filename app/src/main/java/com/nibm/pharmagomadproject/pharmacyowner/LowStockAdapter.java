...
public class LowStockAdapter extends RecyclerView.Adapter<LowStockAdapter.ViewHolder> {
    ...
    public LowStockAdapter(Context context, ArrayList<InventoryModel> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        InventoryModel item = list.get(position);

        holder.txtName.setText(item.getMedicineName());
        holder.txtCategory.setText(item.getCategory());
        holder.txtStock.setText("Stock : " + item.getStock());
        holder.txtReorderLevel.setText("Reorder Level : " + item.getMaxStock());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            txtReorderLevel = itemView.findViewById(R.id.txtReorderLevel);
